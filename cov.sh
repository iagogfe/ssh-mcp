...
SSH_MCP_DISABLE_MAIN=1 npx vitest --run --coverage \
  ...
  test/connection-manager-cache.test.ts test/channel-cap.test.ts test/su-shell.test.ts test/index-units.test.ts test/tmux-runner.test.ts test/config-units.test.ts test/edge-branches.test.ts test/tool-handlers.test.ts \
  "$@" 2>&1 | tail -25
